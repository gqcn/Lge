...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_CN = {
		...
		messages   : {
			...
			'errReplByChild'       : '文件夹 “$1” 不能被包含的目录替换.',
			'errArcSymlinks'       : '无法打开带有连接符号的压缩文件.',
			'errArcMaxSize'        : '压缩文件数超过上限.',
			'errResize'            : 'Unable to resize "$1".',
			'errUsupportType'      : '不支持的文件类型.',
			'errNotUTF8Content'    : '无法编辑非UTF-8编码内容:<br>"$1".',  // added 9.11.2011
			...
			/******************************** sort variants ********************************/
			'sortnameDirsFirst' : '名称 (文件夹靠前)', 
			'sortkindDirsFirst' : '类型 (文件夹靠前)', 
			'sortsizeDirsFirst' : '大小 (文件夹靠前)', 
			'sortdateDirsFirst' : '日期 (文件夹靠前)', 
			'sortname'          : '名称', 
			'sortkind'          : '类型', 
			'sortsize'          : '大小',
			'sortdate'          : '日期',
